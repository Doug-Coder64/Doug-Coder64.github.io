...
export const ProjectList = [
  {
    ...
    title: "Note Taker",
    description:
      "This is an application that can be used to write and save notes. This application uses an Express.js back end and saves and retrieves note data from a JSON file.",
  ...
  },
  {
    ...
    description:
      "A back end for an e-commerce website that uses Express.js, Sequalize and MySQL",
  ...
  {
    img: "https://user-images.githubusercontent.com/85598391/150241289-6aaee5ad-d436-4a11-bb05-4b188ebe0a79.png",
    title: "Pampered Pantry",
    description:
      "This is an application that allows users to add and share their recipes.",
    tech_stack: "MongoDB, Express, GraphQL, JavaScript, HTML, CSS",
    github_url: "https://github.com/DarrickPrichett/Pampered_Pantry",
    demo_url: "https://pampered-pantry.herokuapp.com/",
  },
];
